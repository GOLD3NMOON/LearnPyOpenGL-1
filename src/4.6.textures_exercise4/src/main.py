...
def main():
    ...
    while (not glfw.window_should_close(window)):
        ...
        # define o valor de mistura de texturas no shader
...
def processInput(window):
    ...
    if (glfw.get_key(window, glfw.KEY_UP) == glfw.PRESS):
        mixValue += 0.01 # ajuste este valor conforme necessário (pode ficar lento ou rápido demais, dependendo do hardware do sistema)
